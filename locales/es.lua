Locales['es'] = {
  ...
  ['armory_componenttitle'] = 'armeria - Complementos de arma',
  ['armory_bought'] = 'has comprado una ~y~%s~s~ por ~g~$%s~s~',
  ['armory_money'] = 'no puedes permitirte esa arma',
  ['armory_hascomponent'] = 'ya tienes ese complemento puesto!',
  ...
  ['garage_prompt'] = 'Presionar ~INPUT_CONTEXT~ para acceder a las ~y~Opciones de vehiculo~s~.',
  ...
  ['fine'] = 'Multa por delito',
  ['unpaid_bills'] = 'Multas sin pagar',
  ['license_check'] = 'Administrar licencia',
  ['license_revoke'] = 'Quitar licencias',
  ['license_revoked'] = 'tu ~b~%s~s~ ha sido ~y~retirada~s~!',
  ['licence_you_revoked'] = 'has retirado una ~b~%s~s~ perteneciente a ~y~%s~s~',
  ['no_players_nearby'] = 'no hay jugadores cerca',
  ['being_searched'] = 'estas siendo ~y~cacheado~s~ por la policia ~b~Police~s~',
  -- Vehicle interaction
  ...
  ['search_database'] = 'Info de vehiculos',
